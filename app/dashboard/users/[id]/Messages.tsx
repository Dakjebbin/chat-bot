...
const Messages = () => {
  return (
   ...
   <div className="flex flex-col gap-1 w-[320px]">
      ...
      <div className="flex flex-col w-full overflow-hidden text-wrap leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
         <p className="text-sm text-wrap font-normal text-gray-900 dark:text-white"> That&apos;s awesome. I think our users will really appreciate the improvements.kgjkfgkbkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk</p>
      </div>
